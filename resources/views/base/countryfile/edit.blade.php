      ...
      <div class="mdc-layout-grid__cell--span-12">
        <div class="mdc-card">
          ...
          <div class="template-demo">
            <form action="/base/country/{{ $country->id }}" method="post" class="mt-4" enctype="multipart/form-data">
              @csrf
              @method('patch')
              <div class="row g-3">
                <div class="col-md-4">
              ...
              <div style="width: 300px">
                ...
                <input type="hidden" name="oldImage" value="{{ $country->image }}">
                @if ($country->image)  
                  <img src="{{ asset('storage/'.$country->image) }}" class="img-preview img-fluid">
                @else
