      ...
      <div class="mdc-layout-grid__cell--span-12">
        <div class="mdc-card">
          ...
          <div class="template-demo">
            <form action="/base/product/{{ $product->id }}" method="post" class="mt-4">
              @csrf
              @method('patch')
              <div class="row g-3">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="form-floating">
                        <input type="number" class="form-control form-control-sm mb-3" placeholder="" name="price" value="{{ old('price',$product->price) }}" required>
